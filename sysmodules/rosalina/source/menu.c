...
MyThread *menuCreateThread(void)
{
    ...
    if(R_FAILED(MyThread_Create(&menuThread, menuThreadMain, menuThreadStack, 0x1000, 52, CORE_SYSTEM))) // 0x3000
...
void menuThreadMain(void)
{
    if(!isN3DS)
    {
        ...
        for(u32 i = 5; i <= rosalinaMenu.nbItems; i++) // to hide "New 3DS menu" on o3ds
