...
*/
Result svcMapProcessMemoryExOld(Handle process, u32 destAddr, u32 srcAddr, u32 size);
 ...
 */
Result svcUnmapProcessMemoryExOld(Handle process, u32 destAddress, u32 size);
